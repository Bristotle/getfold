 ...
 *
 * Short is the other constraint, and it was added after measuring. This
 * section ran to 264 words, the heaviest on the homepage, because every
 * claim carried a second clause explaining it. The claims all survived the
 * cut; only the explanations went. A reader scanning eight tiles does not
 * read the second clause anyway.
 *
...
const REASONS = [
  {
    ...
    body: "Bring in the register you already keep and record Sunday's service. No installation, no training day.",
  },
  {
    Icon: Banknote,
    title: "Cash first, always",
    body: "Cash is the default on every giving form. Mobile money sits beside it, never in the way.",
  },
  {
    Icon: Landmark,
    title: "Your denomination's words",
    body: "Society, circuit, class or assembly. Member types are yours, not a list somebody else chose.",
  },
  {
    Icon: Smartphone,
    title: "Built for a phone on a weak signal",
    body: "Install from the browser, no app store. A whole service is one save, not one trip per person.",
  },
  {
    Icon: ShieldCheck,
    title: "No other church can read yours",
    body: "Separated at the database by Postgres itself, not merely hidden behind a menu.",
  },
  {
    Icon: Wallet,
    title: "Your money goes straight to you",
    body: "Paid straight into your church's own account. It never passes through Fold, and we take nothing.",
  },
  {
    Icon: Lock,
    title: "Only leadership sees the giving",
    body: "Pastor, administrator and finance officer. A class leader cannot open the giving at all.",
  },
  {
    Icon: BadgeCheck,
    title: "30 days free, then your call",
    body: "No card to start, nothing to cancel. Export your register whenever you like.",
  },
];
